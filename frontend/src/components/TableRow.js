    ...
    RowDisplay() {
        return (
            <tr>
                ...
                <td>
                    <button className="btn btn-success mr-1" onClick={this.handleToggle.bind(this)} >Redaguoti</button>
                    <button className="btn btn-danger" onClick={this.handleDelete.bind(this)}  >Ištrinti</button>
                </td>
            </tr>
        );
    }
    ...
    RowEdit() {
        return (
            <tr>
                ...
                <td>
                    <button className="btn btn-warning mr-1" onClick={this.handleUpdate.bind(this)}>Išsaugoti</button>
                    <button className="btn btn-danger" onClick={this.handleToggle.bind(this)}>Atšaukti</button>
                </td>
            </tr>
        );
    }
